#!/bin/bash
#SBATCH --job-name=step1_validation
...
#SBATCH --output=/home/Competition2025/P07/自分の個人フォルダ名（例：P07U021）/step1-validation/logs/%x-%j.out
#SBATCH --error=/home/Competition2025/P07/自分の個人フォルダ名（例：P07U021）/step1-validation/logs/%x-%j.err
...
CFG_PATH=/home/Competition2025/P07/自分の個人フォルダ名（例：P07U021）/step1-validation/conf/config_validation.yaml
...
#--- 推論 -----------------------------------------------------------
python predict_validation.py > predict_step1_validation.log 2>&1
