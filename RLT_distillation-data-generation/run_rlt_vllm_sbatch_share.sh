...
#SBATCH --output=/home/Competition2025/P07/自分の個人フォルダ名（例：P07U021）/RLT_distillation-data-generation/logs/%x-%j.out
#SBATCH --error=/home/Competition2025/P07/自分の個人フォルダ名（例：P07U021）/RLT_distillation-data-generation/logs/%x-%j.err
...
CFG_PATH=/home/Competition2025/P07/自分の個人フォルダ名（例：P07U021）/RLT_distillation-data-generation/conf/config.yaml
