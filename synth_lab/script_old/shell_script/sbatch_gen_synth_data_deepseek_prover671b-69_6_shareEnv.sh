...
#SBATCH --job-name=6-Synth_gen_DS-P_V2-671B     # ジョブ名
...
#SBATCH --gpus-per-node=6                       # ノードあたりの GPU 数 (#SBATCH --gres=gpu:1 と同義)
...
srun python /home/Competition2025/P07/shareP07/K_Nishizawa/synth_lab/gen_synth_data_deepseek_prover671b_tf_pp.py 6
