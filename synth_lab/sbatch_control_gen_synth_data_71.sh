#!/usr/bin/env bash
#SBATCH --job-name=Con_gen_synth_DS-P_V2-671B_N71     # ジョブ名
#SBATCH --partition=P07                               # パーティション
#SBATCH --nodelist=osk-gpu71                          # 指定ノード
#SBATCH --nodes=1                                     # ノード数
...
SBATCH_SCRIPT="/home/Competition2025/P07/shareP07/K_Nishizawa/synth_lab/sbatch_gen_synth_data_qwen3_32b_from_DeepMath_71_8.sh"
RUN_FLAG="/home/Competition2025/P07/shareP07/share_gen_synth-data_flag/node_71"
#──────────────────────────────────────────────────────────
