...
def main():
    ...
    bnb_config = BitsAndBytesConfig(
        ...
        llm_int8_enable_fp32_cpu_offload=True,  # offload は使わない
    )

    # 3) Build empty model + balanced dispatch
    # 3) Build an empty model
    # ───── 4) モデル読み込み ─────
    ...
    #     device_map="balanced",   # GPU間でレイヤーを自動分散 :contentReference[oaicite:0]{index=0}
    #     max_memory=max_mem_map,    # 各GPUに割り当てるVRAM上限
    #     trust_remote_code=True,
    #     torch_dtype=torch.bfloat16,
    # )
