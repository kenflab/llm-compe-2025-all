...
def get_process_line_fn(
    ...
    def process_line_fn(line, tokenizer):
        ...
        # BEGIN:JunKato:r1のチャットテンプレートで認識できないタグを削除
        #tags_to_remove = ["<|begin_of_thought|>", "<|end_of_thought|>", "<|begin_of_solution|>", "<|end_of_solution|>"]
        #for tag in tags_to_remove:
        #        line_text = line_text.replace(tag, "")
        # END
